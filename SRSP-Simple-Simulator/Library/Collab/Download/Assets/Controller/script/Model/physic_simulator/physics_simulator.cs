    ...
    private Environement.Environment env;
        ...
        private (float x, float y) nextStep(float ws, float wd, float cs, float cd)
        {
            ...
            else
            {
                ...
                this.AWA = stepAngle - currentAngle;
                ...
                this.STWnorm = VHWVectorNorm * 1.94384f;
                this.STWdir = VHWVectorAngle - this.boat.getCap();
            }
