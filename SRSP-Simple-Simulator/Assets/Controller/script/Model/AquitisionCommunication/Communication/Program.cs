...
namespace Communication
{
    ...
    public class AsynchronousClient
    {
        ...
        public static void StartClient(string ip, int port, IMessageType info)
        {
            ...
            try
            {
                ...
                if (info == IMessageType.BOATLISTREQUEST)
                {
                    ...
                    //Supprimer tout les bateaux et les polaires 
                    //Mettre à 0 la liste
                    FileManageData.ResetAllFiles();
                    FileManageData.ResetBoatList();
                    //
